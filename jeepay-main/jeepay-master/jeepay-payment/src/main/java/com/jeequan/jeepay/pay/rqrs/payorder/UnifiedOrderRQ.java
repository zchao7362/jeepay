...
public class UnifiedOrderRQ extends AbstractMchAppRQ {
    ...
    public UnifiedOrderRQ buildBizRQ(){
        ...
        if(CS.PAY_WAY_CODE.ALI_BAR.equals(wayCode)){
            ...
            BeanUtils.copyProperties(this, bizRQ);
            return bizRQ;
        }else if(CS.PAY_WAY_CODE.ZFT_ALIPAY.equals(wayCode)){
            ZftAliPayOrderRQ bizRQ = JSONObject.parseObject(StringUtils.defaultIfEmpty(this.channelExtra, "{}"), ZftAliPayOrderRQ.class);
            BeanUtils.copyProperties(this, bizRQ);
            return bizRQ;
