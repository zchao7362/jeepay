      ...
      <a-row :gutter="16">
        ...
        <a-col :span="12">
          <a-form-model-item label="应用类型" prop="appType">
            <a-radio-group v-model="saveObject.appType">
              <a-radio :value="0">
                自有应用
              </a-radio>
              <a-radio :value="1">
        ...
        <a-col :span="24">
          <a-form-model-item label="授权码" prop="authCode">
            <a-input v-model="saveObject.authCode" placeholder="请输入" type="text" />
            <a-button type="primary" @click="onSubmit" icon="check" :loading="btnLoading">点击发起授权</a-button>
          </a-form-model-item>
        </a-col>

        <a-col :span="24">
          <a-form-model-item label="卖家支付宝UID" prop="sellerUid">
            <a-input v-model="saveObject.sellerUid" placeholder="请输入" type="text" />
          </a-form-model-item>
        </a-col>
