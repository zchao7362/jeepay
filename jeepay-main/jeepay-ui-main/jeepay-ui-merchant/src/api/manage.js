...
export const API_URL_MCH_INFO = '/api/mchInfo'
/** 商户App管理 **/
...
export function getMchNo (mchNo) {
  return request.request({
    url: '/api/mchApps/mchInfo/' + mchNo,
    method: 'get'
  })
}
...
/** 发送验证码 **/
export function getCodeApi (parameter) {
  return request.request({
    url: '/api/mchTransfers/send/code',
    method: 'POST',
    data: parameter
  })
}
...
/** 查询余额接口 **/
export function queryBalance (parameter) {
  return request.request({
    url: '/api/mchTransfers/getbillBalance',
    method: 'POST',
    data: parameter
  })
}
